  ...
  <header class="flex items-center">
    ...
    <div v-else class="flex ml-auto">
      <div class="dropdown inline-block relative z-10">
        <button
          class="bg-white text-gray-700 w-50 font-semibold py-4 px-6 rounded-lg inline-flex items-center"
        >
          <img
            v-if="$store.state.auth.user.image_url"
            class="rounded-full h-8 border-2 border-bg-white"
            :src="
        ...
        >
          <li class="">
            <nuxt-link
              class="bg-white rounded-t hover:bg-gray-100 hover:text-orange-500 py-2 px-4 block whitespace-no-wrap"
              to="/dashboard"
